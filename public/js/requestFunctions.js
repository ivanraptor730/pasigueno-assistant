                ...
                if (user) {
                    ...
                    ref.once('value', function (snapshot) {
                        ...
                        return firebase.database().ref('users/' + parentKey).once('value').then(function (snapshot) {
                            ...
                            firebase.database().ref("messages/" + barangay + "/" + $usky).push({
                                date: dateToday,
                                time: timeToday,
                                name: "Barangay " + brgy + " Admin",
                                message: "We have successfully responded to your Request with the ID of  " + $id + ". Thank You! This is an Automated Message.",
                                uid: userId
                            });
